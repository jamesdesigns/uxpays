  ...
  return (
    ...
    <Particles
      ...
      <h1 className="text-3xl font-light mb-8 text-white">James Hooper</h1>
        ...
        With a focus on strategic design, I enjoy helping small businesses transform their digital presence and overall business success by creating experiences that resonate with your customers. 
        </p>
      </div>
    </section>
    </>
