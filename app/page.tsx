  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
        ...
        <ul className="flex items-center justify-center gap-4">
          {navigation.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="text-md duration-500 text-gray-400 hover:text-white"
            >
              {item.name}
            </Link>
          ))}
      ...
      <div className="pt-10 pb-22 mx-10 md:mx-22 text-center animate-fade-in">
        ...
        I specialize in transforming the user experience and interface design for large and small business websites. Are you ready to invest in your future? 
        </h2>
        <a
          href="/contact"
